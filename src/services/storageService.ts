...
export const StorageService = {
  ...
  getOptions(): OptionsData {
    ...
    raw['หน่วยงานรับผิดชอบหลัก'] = sortDepartments(combinedDepts);
  ...
  normalizeProject(p: Project): Project {
    // Symmetrically sync Thai keys and English aliases
    const projectName = p['ชื่อโครงการ'] || p.project_name || '';
    const objective = p['วัตถุประสงค์'] || p.objective || '';
    const target = p['เป้าหมาย (ผลผลิต)'] || p.target || '';
    const budget2571 = Number(p['งบประมาณ 2571'] ?? p.budget_2571) || 0;
    const budget2572 = Number(p['งบประมาณ 2572'] ?? p.budget_2572) || 0;
    const budget2573 = Number(p['งบประมาณ 2573'] ?? p.budget_2573) || 0;
    const budget2574 = Number(p['งบประมาณ 2574'] ?? p.budget_2574) || 0;
    const budget2575 = Number(p['งบประมาณ 2575'] ?? p.budget_2575) || 0;
    const expectedOutcome = p['ผลที่คาดว่าจะได้รับ'] || p.expected_outcome || '';
    const department = p['หน่วยงานรับผิดชอบหลัก'] || p.department || '';

    p['ชื่อโครงการ'] = projectName;
    p['วัตถุประสงค์'] = objective;
    p['เป้าหมาย (ผลผลิต)'] = target;
    p['งบประมาณ 2571'] = budget2571;
    p['งบประมาณ 2572'] = budget2572;
    p['งบประมาณ 2573'] = budget2573;
    p['งบประมาณ 2574'] = budget2574;
    p['งบประมาณ 2575'] = budget2575;
    p['ผลที่คาดว่าจะได้รับ'] = expectedOutcome;
    p['หน่วยงานรับผิดชอบหลัก'] = department;

    p.project_name = projectName;
    p.objective = objective;
    p.target = target;
    p.budget_2571 = budget2571;
    p.budget_2572 = budget2572;
    p.budget_2573 = budget2573;
    p.budget_2574 = budget2574;
    p.budget_2575 = budget2575;
    p.expected_outcome = expectedOutcome;
    ...
    if (!p.revisions || p.revisions.length === 0) {
      ...
      const baseRev: ProjectRevision = {
        ...
        data: {
          ...
          'เป้าหมาย (ผลผลิต)': target,
          'งบประมาณ 2571': budget2571,
          'งบประมาณ 2572': budget2572,
          'งบประมาณ 2573': budget2573,
          'งบประมาณ 2574': budget2574,
          'งบประมาณ 2575': budget2575,
          'ผลที่คาดว่าจะได้รับ': expectedOutcome,
          'หน่วยงานรับผิดชอบหลัก': department,
          project_name: projectName,
          objective: objective,
          target: target,
          budget_2571: budget2571,
          budget_2572: budget2572,
          budget_2573: budget2573,
          budget_2574: budget2574,
          budget_2575: budget2575,
