...
import { YEARS, STANDARD_STRATEGIC_ISSUES, sortStrategicIssues, STANDARD_DEPARTMENTS, sortDepartments } from '../data/initialData';
                  ...
                  <div className="grid grid-cols-2 gap-1">
                    ...
                    <div>
                      ...
                      >
                        ...
                        {sortDepartments(options['หน่วยงานรับผิดชอบหลัก'] || STANDARD_DEPARTMENTS).map((opt) => (
                          <option key={opt} value={opt}>
                            {opt}
                          </option>
                        ))}
