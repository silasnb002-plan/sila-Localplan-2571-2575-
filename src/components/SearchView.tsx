...
import { YEARS, TYPE_LIST, STATUS_LIST, ORG_NAME, STANDARD_STRATEGIC_ISSUES, sortStrategicIssues, STANDARD_DEPARTMENTS, sortDepartments } from '../data/initialData';
...
export const SearchView: React.FC<SearchViewProps> = ({
  ...
  // Dynamic unique options derived from project data & standard departments
  const uniqueResponsible = React.useMemo(() => {
    const set = new Set<string>(options['หน่วยงานรับผิดชอบหลัก'] || STANDARD_DEPARTMENTS);
