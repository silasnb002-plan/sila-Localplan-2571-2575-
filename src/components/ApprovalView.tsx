...
import { TYPE_LIST, YEARS, ORG_NAME, ORG_PROVINCE, STANDARD_DEPARTMENTS, sortDepartments } from '../data/initialData';
...
export const ApprovalView: React.FC<ApprovalViewProps> = ({
  ...
  // List of unique departments from projects & standard departments
