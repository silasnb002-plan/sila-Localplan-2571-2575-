...
import { STANDARD_DEPARTMENTS, sortDepartments } from '../data/initialData';
...
export const UserManagementView: React.FC<UserManagementViewProps> = ({
  ...
  const availableDepartments = useMemo(() => {
    ...
    users.forEach((u) => {
      if (u['หน่วยงาน/กอง']) set.add(u['หน่วยงาน/กอง'].trim());
    });
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                ...
                <div>
                  ...
                  >
                    ...
                    {sortDepartments(Array.from(new Set([...STANDARD_DEPARTMENTS, ...(department ? [department] : [])]))).map((dept) => (
